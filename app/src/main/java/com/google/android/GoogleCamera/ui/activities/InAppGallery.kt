...
import com.google.android.GoogleCamera.CapturedItems
import com.google.android.GoogleCamera.GSlideTransformer
import com.google.android.GoogleCamera.GallerySliderAdapter
import com.google.android.GoogleCamera.ITEM_TYPE_VIDEO
import com.google.android.GoogleCamera.R
import com.google.android.GoogleCamera.databinding.GalleryBinding
import com.google.android.GoogleCamera.util.storageLocationToUiString
...
class InAppGallery : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.status_bar_color_gallery));
        getWindow().setNavigationBarColor(ContextCompat.getColor(this, R.color.status_bar_color_gallery));
//        if (!isDarkMode(this)){
